namespace EsiniBulOyunu
{
    public partial class Form1 : Form
    {
        ...
        private void KartlariDiz()
        {
            ...
            for (int y = 0; y < boyut; y++)
            {
                for (int x = 0; x < boyut; x++)
                {
                    ...
                    resimKutusu.Left = x * (resimKutusu.Width + 10);
                    resimKutusu.Top = y * (resimKutusu.Height + 10);
        ...
        private void ResimKutusu_Click(object? sender, EventArgs e)
        {
            ...
            // yeni bir resim kutusuna týklandýðýnda önceden açýklarýn kapanmasý
            if (aciklar.Count == 2)
            {
            ...
            // 2. kartý açtýðýnda yapýlacak eþleþme kontrolu
